...
import be.isach.ultracosmetics.v1_13_R2.customentities.Pumpling;
...
public abstract class CustomEntityPet extends Pet {
	...
	public void onEquip() {
		...
		((org.bukkit.craftbukkit.v1_13_R2.CraftWorld) getPlayer().getWorld()).getHandle().addEntity(getCustomEntity());
