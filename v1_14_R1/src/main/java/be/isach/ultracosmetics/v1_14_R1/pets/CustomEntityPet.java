...
import be.isach.ultracosmetics.v1_14_R1.customentities.Pumpling;
...
public abstract class CustomEntityPet extends Pet {
	...
	public void onEquip() {
		...
		((org.bukkit.craftbukkit.v1_14_R1.CraftWorld) getPlayer().getWorld()).getHandle().addEntity(getCustomEntity());
