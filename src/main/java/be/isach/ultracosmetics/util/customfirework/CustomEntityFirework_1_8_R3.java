...
public class CustomEntityFirework_1_8_R3 extends EntityFireworks {
    Player[] players = null;
    ...
    public static void spawn(Location location, FireworkEffect effect, Player... players) {
        try {
            CustomEntityFirework_1_8_R3 firework = new CustomEntityFirework_1_8_R3(((CraftWorld) location.getWorld()).getHandle(), players);
