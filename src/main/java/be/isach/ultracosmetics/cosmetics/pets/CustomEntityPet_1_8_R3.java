...
public class CustomEntityPet_1_8_R3 extends Pet {
    ...
    @Override
    public void equip() {
        followTask = new PlayerFollower_1_8_R3(this, getPlayer());
        ...
        customEntity = new Pumpling1_8_R3(((CraftPlayer) getPlayer()).getHandle().getWorld());
        Pumpling1_8_R3.customEntities.add(((org.bukkit.craftbukkit.v1_8_R3.entity.CraftEntity) customEntity.getEntity()).getHandle());
    ...
    protected void removeEntity() {
        getCustomEntity().dead = true;
        Pumpling1_8_R3.customEntities.remove(customEntity);
    }
