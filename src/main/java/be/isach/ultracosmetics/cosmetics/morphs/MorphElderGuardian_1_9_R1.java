 ...
 */
public class MorphElderGuardian_1_9_R1 extends Morph {
    ...
    private CustomGuardian_1_9_R1 customGuardian;

    public MorphElderGuardian_1_9_R1(UUID owner) {
        ...
        customGuardian = new CustomGuardian_1_9_R1(world);
