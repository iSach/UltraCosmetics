...
public class MountType extends CosmeticEntType<Mount> {
    ...
    public static final MountType WALKINGDEAD = new MountType("ultracosmetics.mounts.walkingdead", "WalkingDead", Material.ROTTEN_FLESH, (byte) 0, EntityType.HORSE, "&7&oGraaaaw...", 2, MountWalkingDead.class);
    ...
    public static final MountType RUDOLPH = new MountType("ultracosmetics.mounts.rudolph", "Rudolph", Material.DEAD_BUSH, (byte) 0, EntityType.HORSE, "&7&oWhat would be Christmas\n&7&owithout Rudolph the Reeinder?", 2, MountRudolph.class);
