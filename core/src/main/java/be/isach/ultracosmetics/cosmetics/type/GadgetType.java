...
public class GadgetType extends CosmeticMatType<Gadget> {
	...
	public static void register() {
		new GadgetType(BlockUtils.getOldMaterial("IRON_BARDING"), (byte) 0, 8, "ultracosmetics.gadgets.batblaster", "BatBlaster", "&7&oLaunch waves of annoying bats\n&7&oto people you don't like!", GadgetBatBlaster.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("MELON_BLOCK"), (byte) 0, 2, "ultracosmetics.gadgets.melonthrower", "MelonThrower", "&7&oDeliciously fun!", GadgetMelonThrower.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("REDSTONE_COMPARATOR"), (byte) 0, 2, "ultracosmetics.gadgets.portalgun", "PortalGun", "&7&oMomentum, a function of " + "mass and velocity,\n&7&ois converved between portals. In Layman''s terms,\n&7&ospeedy thing goes in, speedy thing goes out.", GadgetPortalGun.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("DIAMOND_BARDING"), (byte) 0, 0.5, "ultracosmetics.gadgets.paintballgun", "PaintballGun", "&7&oPEW PEW PEW PEW!!!", GadgetPaintballGun.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("EYE_OF_ENDER"), (byte) 0, 30, "ultracosmetics.gadgets.antigravity", "AntiGravity", "&7&oYou don't like gravity?" + "\n&7&oThen, this gadget is made for you!", GadgetAntiGravity.class, ServerVersion.v1_8_R1);
		new GadgetType(BlockUtils.getOldMaterial("FIREWORK_CHARGE"), (byte) 0, 15, "ultracosmetics.gadgets.smashdown", "SmashDown", "&7&oAND HIS NAME IS... JOHN CENA!!", GadgetSmashDown.class, ServerVersion.v1_8_R1);
		new GadgetType(BlockUtils.getOldMaterial("FIREWORK"), (byte) 0, 60, "ultracosmetics.gadgets.rocket", "Rocket", "&7&oHouston, we have got a problem..", GadgetRocket.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("LEASH"), (byte) 0, 60, "ultracosmetics.gadgets.parachute", "Parachute", "&7&oGERONIMOooo!", GadgetParachute.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("SKULL_ITEM"), (byte) 0, 45, "ultracosmetics.gadgets.ghostparty", "GhostParty", "&7&oWho Ya Gonna Call?\n&f&lGHOST &4&lBUSTERS!", GadgetGhostParty.class, ServerVersion.v1_8_R1);
		new GadgetType(BlockUtils.getOldMaterial("FIREWORK"), (byte) 0, 0.2, "ultracosmetics.gadgets.firework", "Firework", "&7&oNeed to celebrate?\n&7&oUse fireworks!", GadgetFirework.class, ServerVersion.v1_8_R1);
		new GadgetType(BlockUtils.getOldMaterial("LONG_GRASS"), (byte) 2, 20, "ultracosmetics.gadgets.christmastree", "ChristmasTree", "&7&oHere is a Christmas" + "\n&7&oTree for you!", GadgetChristmasTree.class, ServerVersion.v1_8_R1);
		...
		new GadgetType(BlockUtils.getOldMaterial("SNOW_BALL"), (byte) 0, 0.5, "ultracosmetics.gadgets.snowball", "Snowball", "&7&oJoin in on the festive fun by\n" + "&7&othrowing snow at people!", GadgetSnowball.class, ServerVersion.v1_8_R1);
		...
		if (VersionManager.IS_VERSION_1_13) {
			new GadgetType(BlockUtils.getBlockByColor("WOOL", (byte) 3), (byte) 0, 25, "ultracosmetics.gadgets.colorbomb", "ColorBomb", "&7&oA colorful bomb!", GadgetColorBomb.class, ServerVersion.v1_13_R1);
			new GadgetType(BlockUtils.getBlockByColor("WOOL", (byte) 11), (byte) 0, 75, "ultracosmetics.gadgets.trampoline", "Trampoline", "&7&oConstructs a trampoline!" + "\n&7&othat sends you and your\n&7&ofriends into air!", GadgetTrampoline.class, ServerVersion.v1_13_R1);
			new GadgetType(BlockUtils.getBlockByColor("STAINED_CLAY", (byte) 15), (byte) 0, 35, "ultracosmetics.gadgets.blackhole", "BlackHole", "&7&oYou should not get caught by it..", GadgetBlackHole.class, ServerVersion.v1_13_R1);
		} else {
			new GadgetType(BlockUtils.getOldMaterial("WOOL"), (byte) 3, 25, "ultracosmetics.gadgets.colorbomb", "ColorBomb", "&7&oA colorful bomb!", GadgetColorBomb.class, ServerVersion.v1_8_R1);
			new GadgetType(BlockUtils.getOldMaterial("WOOL"), (byte) 11, 75, "ultracosmetics.gadgets.trampoline", "Trampoline", "&7&oConstructs a trampoline!" + "\n&7&othat sends you and your\n&7&ofriends into air!", GadgetTrampoline.class, ServerVersion.v1_8_R1);
			new GadgetType(BlockUtils.getOldMaterial("STAINED_CLAY"), (byte) 15, 35, "ultracosmetics.gadgets.blackhole", "BlackHole", "&7&oYou should not get caught by it..", GadgetBlackHole.class, ServerVersion.v1_8_R1);
		}
	}
}
